...
describe("generate render-camera-cursor golden", () => {
  it("writes the fixture", () => {
    ...
    const fixture = {
      version: 1,
      description:
        "Cross-language render golden for the camera/cursor WYSIWYG math. TS preview (screen-record/src/lib/renderer/cameraZoom.ts + cursorDynamics.ts) is canonical; Rust export (src/overlay/screen_record/native_export/camera_path.rs + cursor_path/{spring,processing}.rs) must match within 1e-6. Generated by tests/unit/_generateRenderGolden.gen.ts — never hand-edit numbers. See .claude/parity/render-camera-cursor.md.",
      tolerance: 1e-6,
