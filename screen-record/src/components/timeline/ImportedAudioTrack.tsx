...
export const ImportedAudioTrack: React.FC<ImportedAudioTrackProps> = ({
  ...
  countFrontendRender("ImportedAudioTrack");
        ...
        return (
            ...
            style={{
              ...
              background:
                hasCoveredSegmentUnderneath
                  ...
                  : isSelected
                    ? "color-mix(in srgb, var(--primary-color) 18%, var(--ui-surface-3))"
                  : "color-mix(in srgb, var(--primary-color) 22%, var(--ui-surface-3))",
          ...
          >
            ...
            {shouldRenderWaveform ? (
              ...
              <div
                className="audio-track-segment-content absolute inset-0 z-[1] flex min-w-0 items-center gap-1.5 overflow-hidden px-1.5 text-[10px] text-[var(--on-surface)]"
