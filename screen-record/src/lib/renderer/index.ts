...
class VideoRenderer {
  ...
  constructor() {
    ...
    this.state = {
      ...
      lastDrawTime: 0,
      latestElapsed: 0,
      skippedPreviewDrawCount: 0,
      lastPreviewSkipLogTime: 0,
      slowPreviewFrameCount: 0,
      lastPreviewPerfLogTime: 0,
      lastSubtitleVisibilityLogTime: 0,
      lastSubtitleVisibilitySignature: '',
