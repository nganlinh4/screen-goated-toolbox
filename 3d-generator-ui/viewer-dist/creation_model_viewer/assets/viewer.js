...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Os(e,t,n){let r=new Float32Array(ms),i=new G(0,1,0);return new ba({name:`SphericalGaussianBlur`,defines:{n:ms,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:js(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(){return new ba({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:js(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(){return new ba({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:js(),fragmentShader:`
	...
	`}var Ms=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Hd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Ud=new So(-1,1,1,-1,0,1),Wd=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new vr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new vr([0,2,0,0,2,0],2))}},Gd=class{constructor(e){this._mesh=new ni(Wd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ud)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Kd=class extends Hd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ba?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=_a.clone(e.uniforms),this.material=new ba({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Gd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},qd=class extends Hd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Jd=class extends Hd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Yd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Zt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Kd(Vd),this.copyPass.material.blending=0,this.timer=new Mo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}qd!==void 0&&(r instanceof qd?n=!0:r instanceof Jd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Xd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Zd=class extends Hd{constructor(){super(),this.isOutputPass=!0,this.uniforms=_a.clone(Xd.uniforms),this.material=new xa({name:Xd.name,uniforms:this.uniforms,vertexShader:Xd.vertexShader,fragmentShader:Xd.fragmentShader}),this._fsQuad=new Gd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Qd=class extends Hd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},$d=class{revision=0;activeAbort;settled=Promise.resolve();invalidate(){this.revision+=1,this.activeAbort?.abort()}async run(e,t){let n=++this.revision;this.activeAbort?.abort();let r=new AbortController;if(this.activeAbort=r,await this.settled,n!==this.revision||r.signal.aborted)return null;let i=e(r.signal);this.settled=i.then(()=>void 0,()=>void 0);try{let e=await i;return n!==this.revision||r.signal.aborted?(t(e),null):e}catch(e){if(n!==this.revision||r.signal.aborted)return null;throw e}finally{this.activeAbort===r&&(this.activeAbort=void 0)}}},ef=1024,tf=5e5,nf=15e5,rf=class{parent;rank;constructor(e){this.parent=Int32Array.from({length:e},(e,t)=>t),this.rank=new Uint8Array(e)}find(e){let t=e;for(;this.parent[t]!==t;)t=this.parent[t];for(;this.parent[e]!==e;){let n=this.parent[e];this.parent[e]=t,e=n}return t}join(e,t){let n=this.find(e),r=this.find(t);n!==r&&(this.rank[n]<this.rank[r]&&([n,r]=[r,n]),this.parent[r]=n,this.rank[n]===this.rank[r]&&(this.rank[n]+=1))}};function af(e){let t=e.getAttribute(`position`),n=e.getIndex();if(!t||!n||t.count>tf||n.count>nf||n.count<6||n.count%3!=0||e.groups.length>1)return[];let r=new rf(t.count);for(let e=0;e<n.count;e+=3){let i=n.getX(e),a=n.getX(e+1),o=n.getX(e+2);if(i>=t.count||a>=t.count||o>=t.count)return[];r.join(i,a),r.join(i,o)}let i=new Map;for(let e=0;e<n.count;e+=3){let t=n.getX(e),a=r.find(t),o=i.get(a)||[];if(o.push(t,n.getX(e+1),n.getX(e+2)),i.set(a,o),i.size>ef)return[]}return i.size>1?[...i.values()]:[]}function of(e,t){let n=new Ar;for(let t of Object.keys(e.attributes))n.setAttribute(t,e.getAttribute(t));let r=e.morphAttributes,i=n.morphAttributes;for(let[e,t]of Object.entries(r))i[e]=t;n.morphTargetsRelative=e.morphTargetsRelative;let a=t.reduce((e,t)=>Math.max(e,t),0)<=65535?new Uint16Array(t):new Uint32Array(t);return n.setIndex(new hr(a,1)),n}function sf(e,t){t.position.copy(e.position),t.quaternion.copy(e.quaternion),t.scale.copy(e.scale),t.matrix.copy(e.matrix),t.matrixAutoUpdate=e.matrixAutoUpdate,t.visible=e.visible,t.layers.mask=e.layers.mask,t.renderOrder=e.renderOrder,t.userData={...e.userData}}function cf(e,t){let n=e.parent;if(!n)return;let r=n.children.indexOf(e),i=new On;i.name=e.name,sf(e,i);for(let t of[...e.children])i.add(t);t.forEach((t,n)=>{let r=new ni(of(e.geometry,t),e.material);r.name=`part_${String(n+1).padStart(3,`0`)}`,r.castShadow=e.castShadow,r.receiveShadow=e.receiveShadow,r.frustumCulled=!1,r.userData={...e.userData},i.add(r)}),n.remove(e),n.add(i),n.children.splice(n.children.indexOf(i),1),n.children.splice(r,0,i),e.geometry.dispose()}function lf(e,t){let n=[];e.traverse(e=>{e instanceof ni&&!(e instanceof mi)&&n.push(e)});let r=t&&n.length===1;for(let e of n){if(e.geometry.getAttribute(`normal`)||e.geometry.computeVertexNormals(),!r)continue;let t=af(e.geometry);t.length>1&&cf(e,t)}}var uf=`sgtQuadWireframe`;function df(e){let t,n;return e.traverse(e=>{let r=e.userData;!r||r[uf]!==!0||(typeof r.polygonCount==`number`&&(t=r.polygonCount),typeof r.quadCount==`number`&&(n=r.quadCount))}),{polygons:t,quads:n}}function ff(e){let t={vertices:0,faces:0},n=new WeakSet,r=new WeakSet,i=new WeakMap;e.traverse(e=>{if(!(e instanceof ni))return;let a=e.geometry.getAttribute(`position`);if(!a)return;n.has(a)||(n.add(a),t.vertices+=a.count);let o=e.geometry.getIndex();if(!o){r.has(a)||(r.add(a),t.faces+=Math.floor(a.count/3));return}let s=i.get(a);s||(s=new WeakSet,i.set(a,s)),s.has(o)||(s.add(o),t.faces+=Math.floor(o.count/3))});let{polygons:a,quads:o}=df(e);return a!==void 0&&(t.polygons=a),o!==void 0&&(t.quads=o),t}var pf={uniforms:{tDiffuse:{value:null},tMetadata:{value:null},tDepth:{value:null},uTexel:{value:new W(1,1)},uInk:{value:new Y(529682)},uStrength:{value:1}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function mf(e){return e.length===1?e[0]:e}function hf(e){return e.side=2,e.needsUpdate=!0,e}function gf(e,t){let n=e;return new wa({color:n.color?.clone()||new Y(16777215),map:n.map||null,normalMap:n.normalMap||null,alphaMap:n.alphaMap||null,aoMap:n.aoMap||null,emissive:n.emissive?.clone()||new Y(0),emissiveMap:n.emissiveMap||null,side:2,transparent:n.transparent,opacity:n.opacity,alphaTest:n.alphaTest,vertexColors:n.vertexColors,gradientMap:t})}function _f(e,t,n){let r=e.map(hf),i=e.map(e=>gf(e,n)),a=e.map(()=>new wa({color:t,gradientMap:n,side:2,transparent:!1,opacity:1}));return{original:mf(r),toon:mf(i),parts:mf(a)}}var vf=class{mixer;action=null;selected=-1;playing=!1;speed=1;root;clips;constructor(e,t){this.root=e,this.clips=t,this.mixer=new Yo(e),t.length&&this.select(0)}state(){return{clips:this.clips.map((e,t)=>e.name||String(t+1)),selected:this.selected,playing:this.playing,time:this.action?.time??0,duration:this.clips[this.selected]?.duration??0,speed:this.speed}}select(e){!Number.isInteger(e)||e<0||e>=this.clips.length||(this.mixer.stopAllAction(),this.selected=e,this.playing=!1,this.action=this.mixer.clipAction(this.clips[e]).reset().play(),this.action.paused=!0,this.mixer.update(0))}setPlaying(e){this.playing=e&&this.action!==null&&this.state().duration>0,this.action&&(this.action.paused=!this.playing)}seek(e){if(!this.action||!Number.isFinite(e))return;let t=this.state().duration;this.action.time=jt.clamp(e,0,Math.max(0,t-1e-7)),this.mixer.update(0),this.root.updateMatrixWorld(!0)}setSpeed(e){Number.isFinite(e)&&e>=.25&&e<=2&&(this.speed=e)}update(e){return!this.playing||!Number.isFinite(e)||e<=0?!1:(this.mixer.update(Math.min(e,.1)*this.speed),this.root.updateMatrixWorld(!0),!0)}resetPose(){this.playing=!1,this.mixer.stopAllAction(),this.action=null,this.selected=-1,this.root.updateMatrixWorld(!0)}dispose(){this.resetPose(),this.mixer.uncacheRoot(this.root),this.clips=[]}};function yf(e,t,n){let r=Math.tan(t*Math.PI/360)*Math.min(1,n);return Math.max(1.7,e/r*1.12)}function bf(e,t){return Math.min(1,e)/Math.min(1,t)}var xf={animationClip:`Animation`,playAnimation:`Play`,pauseAnimation:`Pause`,animationTime:`Animation time`,animationSpeed:`Playback speed`,resetPose:`Rest pose`},Sf=class{element=document.createElement(`div`);clips=document.createElement(`select`);play=document.createElement(`button`);seek=document.createElement(`input`);speed=document.createElement(`select`);reset=document.createElement(`button`);time=document.createElement(`output`);playback=null;labels=xf;render;constructor(e,t){this.render=t,this.element.className=`viewer-playback`,this.element.hidden=!0,this.clips.className=`viewer-playback-clips`,this.play.className=`viewer-playback-play`,this.seek.className=`viewer-playback-seek`,this.speed.className=`viewer-playback-speed`,this.reset.className=`viewer-playback-reset`,this.time.className=`viewer-playback-time`,this.time.setAttribute(`aria-live`,`off`),this.play.type=this.reset.type=`button`,this.seek.type=`range`,this.seek.min=`0`,this.seek.step=`0.001`;for(let e of[.25,.5,1,1.5,2])this.speed.add(new Option(`${e}×`,String(e)));this.speed.value=`1`,this.element.append(this.clips,this.play,this.seek,this.time,this.speed,this.reset),e.append(this.element),this.clips.addEventListener(`change`,()=>this.change(()=>{this.clips.value===`-1`?this.playback?.resetPose():this.playback?.select(Number(this.clips.value))})),this.play.addEventListener(`click`,()=>this.change(()=>{this.playback?.state().selected===-1&&this.playback.select(0),this.playback?.setPlaying(!this.playback.state().playing)})),this.seek.addEventListener(`input`,()=>this.change(()=>{this.playback?.setPlaying(!1),this.playback?.seek(Number(this.seek.value))})),this.speed.addEventListener(`change`,()=>this.change(()=>{this.playback?.setSpeed(Number(this.speed.value))})),this.reset.addEventListener(`click`,()=>this.change(()=>this.playback?.resetPose())),this.setLabels(xf)}setLabels(e){this.labels=e,this.clips.setAttribute(`aria-label`,e.animationClip),this.seek.setAttribute(`aria-label`,e.animationTime),this.speed.setAttribute(`aria-label`,e.animationSpeed),this.reset.textContent=e.resetPose,this.clips.options.length&&(this.clips.options[0].text=e.resetPose),this.update()}bind(e){this.playback=e,this.clips.replaceChildren(),this.clips.add(new Option(this.labels.resetPose,`-1`)),e?.state().clips.forEach((e,t)=>{this.clips.add(new Option(e,String(t)))}),this.element.hidden=!e?.state().clips.length,this.update()}update(){let e=this.playback?.state();e&&(this.play.textContent=e.playing?this.labels.pauseAnimation:this.labels.playAnimation,this.play.setAttribute(`aria-pressed`,String(e.playing)),this.clips.value=String(e.selected),this.seek.max=String(e.duration),this.seek.value=String(e.time),this.seek.disabled=e.selected<0,this.time.value=`${e.time.toFixed(1)} / ${e.duration.toFixed(1)}s`,this.speed.value=String(e.speed))}dispose(){this.bind(null),this.element.remove()}change(e){e(),this.update(),this.render()}},Cf=`sgtQuadWireframe`,wf=[2341279,15908181,6266856,15169880,10124244,6731896,13725086,5092040],Tf=104857600,Ef=class{canvas;container;renderer;scene=new In;camera=new _o(34,1,.01,100);controls;composer;edgePass;metadataTarget;metadataMaterial;metadataIds=new WeakMap;result=null;idleObject;grid=new Zo(4,20,2341279,4345935);startedAt=performance.now();modelBlend=0;hasSegmentedParts=!1;resizeObserver;shading=`original`;outline=!0;wireframe=!1;quadEdges=[];contentRevision=0;modelLoads=new $d;frameRequest=0;interacting=!1;interactionListener;theme=`dark`;disposed=!1;playback=null;playbackPanel;previousFrame=0;hemisphere=new io(15072245,1713444,2.15);key=new wo(16121849,3.2);rim=new wo(5556659,2);constructor(e,t){this.canvas=e,this.container=t,this.renderer=new gu({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`}),this.renderer.outputColorSpace=We,this.renderer.setPixelRatio(this.pixelRatio()),this.camera.position.set(0,.1,3.4),this.controls=new Eu(this.camera,this.canvas),this.controls.enableDamping=!1,this.controls.enablePan=!0,this.controls.minDistance=.7,this.controls.maxDistance=10,this.controls.autoRotateSpeed=1.15,this.controls.enabled=!1,this.controls.addEventListener(`start`,()=>{this.interacting=!0,this.interactionListener?.(!0),this.requestRender()}),this.controls.addEventListener(`change`,()=>this.requestRender()),this.controls.addEventListener(`end`,()=>{this.interacting=!1,this.interactionListener?.(!1),this.requestRender()}),this.key.position.set(3,4,5),this.rim.position.set(-4,1,-2),this.scene.add(this.hemisphere,this.key,this.rim),this.grid.position.y=-.82,this.grid.visible=!1,this.scene.add(this.grid);let n=new Zt(1,1,{depthBuffer:!0});n.samples=Math.min(2,this.renderer.capabilities.maxSamples),this.composer=new Yd(this.renderer,n),this.composer.addPass(new Qd(this.scene,this.camera)),this.edgePass=new Kd(pf),this.composer.addPass(this.edgePass),this.composer.addPass(new Zd),this.metadataTarget=new Zt(1,1,{depthBuffer:!0,depthTexture:new aa(1,1,_),minFilter:o,magFilter:o}),this.metadataTarget.texture.colorSpace=``,this.metadataMaterial=new ba({uniforms:{uSurfaceId:{value:0}},vertexShader:rs.normal.vertexShader,fragmentShader:`
      ...
      `,side:2,depthTest:!0,depthWrite:!0}),this.metadataMaterial.onBeforeRender=(e,t,n,r,i)=>{this.metadataMaterial.uniforms.uSurfaceId.value=this.metadataIds.get(i)||0},this.playbackPanel=new Sf(t,()=>{this.previousFrame=0,this.requestRender()}),document.addEventListener(`visibilitychange`,this.visibilityChanged),this.idleObject=this.createIdleObject(),this.scene.add(this.idleObject),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(t),this.setTheme(document.documentElement.dataset.theme===`light`?`light`:`dark`),this.resize(),this.requestRender()}onInteractionChange(e){this.interactionListener=e}setPlaybackLabels(e){this.playbackPanel.setLabels(e)}visibilityChanged=()=>{this.previousFrame=0,this.requestRender()};dispose(){this.disposed||(this.disposed=!0,this.cancelPendingModelLoad(),this.frameRequest&&cancelAnimationFrame(this.frameRequest),this.frameRequest=0,this.resizeObserver.disconnect(),this.interactionListener=void 0,this.controls.dispose(),this.clearResult(),this.playbackPanel.dispose(),document.removeEventListener(`visibilitychange`,this.visibilityChanged),this.disposeGroup(this.idleObject),this.grid.geometry.dispose(),(Array.isArray(this.grid.material)?this.grid.material:[this.grid.material]).forEach(e=>e.dispose()),this.scene.userData.toonGradient?.dispose(),this.metadataMaterial.dispose(),this.metadataTarget.dispose(),this.composer.dispose(),this.renderer.dispose(),this.renderer.forceContextLoss())}pixelRatio(){return Math.min(1.5,Math.max(1,window.devicePixelRatio))}createIdleObject(){let e=new On,t=new ua(.68,3);return e.add(new na(t,new Zi({color:2341279,size:.018,transparent:!0,opacity:.7})),new ni(t,new Wr({color:6717820,wireframe:!0,transparent:!0,opacity:.2}))),e.position.y=.12,e}setTheme(e){this.theme=e;let t=e===`light`?15988726:1317144;this.scene.background=new Y(t),this.renderer.setClearColor(t,1),this.edgePass.uniforms.uInk.value.set(e===`light`?2112310:463375),this.hemisphere.color.set(e===`light`?16777215:14679028),this.hemisphere.groundColor.set(e===`light`?10202282:1319199),this.key.color.set(e===`light`?16776693:15990777),this.rim.color.set(e===`light`?1481604:5556659),this.requestRender()}showIdle(){this.cancelPendingModelLoad(),this.clearResult(),this.idleObject.visible=!0,this.controls.enabled=!1,this.camera.position.set(0,.1,3.4),this.camera.lookAt(0,0,0),this.requestRender()}cancelPendingModelLoad(){++this.contentRevision,this.modelLoads.invalidate()}async setModel(e,t){let n=++this.contentRevision,r=await this.modelLoads.run(t=>this.loadModel(e,t),e=>this.disposeGroup(e));if(!r)return null;if(n!==this.contentRevision)return this.disposeGroup(r),null;try{this.idleObject.visible=!1,lf(r,t&&r.animations.length===0);let e=ff(r),n=new Zn().setFromObject(r),i=n.getCenter(new G),a=n.getSize(new G),o=new On,s=1.55/Math.max(a.x,a.y,a.z,.001);o.scale.setScalar(s),o.position.copy(i).multiplyScalar(-s),o.add(r),o.updateMatrixWorld(!0),this.adoptQuadEdges(r);let c=0;r.traverse(e=>{if(!(e instanceof ni))return;r.animations.length&&(e.frustumCulled=!1);let t=_f(Array.isArray(e.material)?e.material:[e.material],wf[c%wf.length],this.toonGradient());e.userData.viewerMaterials=t,this.metadataIds.set(e,(c%254+1)/255),e.castShadow=!1,e.receiveShadow=!1,c+=1}),this.playback?.dispose(),this.disposeGroup(this.result);let l=new On;return l.add(o),this.result=l,this.playback=new vf(r,r.animations),this.playbackPanel.bind(this.playback),this.previousFrame=0,this.scene.add(l),this.hasSegmentedParts=t&&c>1,this.shading=`original`,this.applyMaterials(),this.modelBlend=0,this.controls.enabled=!0,this.resize(),this.fitView(),this.requestRender(),e}catch(e){throw this.disposeGroup(r),e}}async loadModel(e,t){let n=await fetch(e,{cache:`no-store`,signal:t});if(!n.ok)throw Error(`Model preview was unavailable`);let r=Number(n.headers.get(`content-length`)||0);if(r!==0&&(!Number.isSafeInteger(r)||r<20||r>Tf))throw Error(`Model preview exceeded its size limit`);let i=await n.arrayBuffer();if(i.byteLength<20||i.byteLength>Tf)throw Error(`Model preview exceeded its size limit`);if(t.aborted)throw Error(`Model preview was superseded`);let a=await new Hu().parseAsync(i,``);return a.scene.animations=a.animations,a.scene}toonGradient(){let e=this.scene.userData.toonGradient;if(e)return e;let t=new gi(new Uint8Array([72,132,194,255]),4,1,A);return t.minFilter=o,t.magFilter=o,t.colorSpace=``,t.needsUpdate=!0,this.scene.userData.toonGradient=t,t}setShading(e){e===`parts`&&!this.hasSegmentedParts||(this.shading=e,this.applyMaterials(),this.requestRender())}getShading(){return this.shading}hasParts(){return this.hasSegmentedParts}setOutline(e){this.outline=e,this.edgePass.uniforms.uStrength.value=e?.92:0,this.resize(),this.requestRender()}setAutoRotate(e){this.controls.autoRotate=e,this.requestRender()}setGrid(e){this.grid.visible=e&&!!this.result,this.requestRender()}setWireframe(e){this.wireframe=e,this.applyMaterials(),this.requestRender()}fitView(){if(!this.result)return;let e=new Zn().setFromObject(this.result),t=e.getSize(new G),n=e.getCenter(new G),r=yf(Math.max(t.x,t.y,t.z)*.62,this.camera.fov,this.camera.aspect);this.controls.maxDistance=Math.max(10,r*2),this.controls.target.copy(n),this.camera.position.set(n.x+r*.12,n.y+r*.04,n.z+r),this.camera.near=Math.max(.001,r/1e3),this.camera.far=r*50,this.camera.updateProjectionMatrix(),this.controls.update(),this.requestRender()}applyMaterials(){this.result?.traverse(e=>{if(!(e instanceof ni))return;let t=e.userData.viewerMaterials;t&&(e.material=t[this.shading],(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{`wireframe`in e&&(e.wireframe=this.wireframe&&!this.hasQuadEdges()),e.needsUpdate=!0}))}),this.quadEdges.forEach(e=>{e.visible=this.wireframe;let t=e.material;t.opacity=this.modelBlend,t.needsUpdate=!0}),this.edgePass.uniforms.uStrength.value=this.outline?.92:0}hasQuadEdges(){return this.quadEdges.length>0}adoptQuadEdges(e){this.quadEdges=[],e.traverse(e=>{if(!(e instanceof Yi)||e.userData?.[Cf]!==!0)return;let t=new Li({color:1185306,transparent:!0,opacity:0,depthTest:!0});(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()),e.material=t,e.renderOrder=2,e.visible=!1,this.quadEdges.push(e)})}clearResult(){this.playback?.dispose(),this.playback=null,this.playbackPanel.bind(null),this.disposeGroup(this.result),this.result=null,this.quadEdges=[],this.hasSegmentedParts=!1,this.grid.visible=!1,this.modelBlend=0,this.resize()}disposeGroup(e){if(!e)return;this.scene.remove(e);let t=new Set,n=new Set,r=new Set,i=this.scene.userData.toonGradient;e.traverse(e=>{if(e instanceof mi&&!r.has(e.skeleton)&&(r.add(e.skeleton),e.skeleton.dispose()),!(e instanceof ni||e instanceof na||e instanceof Yi))return;e.geometry?.dispose();let a=e.userData.viewerMaterials;(a?[a.original,a.toon,a.parts].flatMap(e=>Array.isArray(e)?e:[e]):Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{t.has(e)||(t.add(e),Object.values(e).forEach(e=>{e instanceof Jt&&e!==i&&!n.has(e)&&(n.add(e),e.dispose())}),e.dispose())})})}resize(){let e=Math.max(1,this.container.clientWidth),t=Math.max(1,this.container.clientHeight),n=this.pixelRatio();this.renderer.setPixelRatio(n),this.renderer.setSize(e,t,!1),this.composer.setPixelRatio(n),this.composer.setSize(e,t);let r=this.outline&&!!this.result;this.edgePass.enabled=r,this.metadataTarget.setSize(r?e*n:1,r?t*n:1),this.edgePass.uniforms.uTexel.value.set(.78/(e*n),.78/(t*n));let i=e/t;if(this.result&&i!==this.camera.aspect){let e=bf(this.camera.aspect,i);this.camera.position.sub(this.controls.target).multiplyScalar(e).add(this.controls.target),this.controls.maxDistance=Math.max(10,this.camera.position.distanceTo(this.controls.target)*2),this.camera.far=Math.max(100,this.controls.maxDistance*25)}this.camera.aspect=i,this.camera.updateProjectionMatrix(),this.requestRender()}renderMetadata(){let e=this.renderer.getRenderTarget(),t=this.scene.overrideMaterial,n=this.renderer.getClearColor(new Y),r=this.renderer.getClearAlpha();this.scene.overrideMaterial=this.metadataMaterial,this.renderer.setRenderTarget(this.metadataTarget),this.renderer.setClearColor(0,0),this.renderer.clear(!0,!0,!0),this.renderer.render(this.scene,this.camera),this.scene.overrideMaterial=t,this.renderer.setRenderTarget(e),this.renderer.setClearColor(n,r),this.edgePass.uniforms.tMetadata.value=this.metadataTarget.texture,this.edgePass.uniforms.tDepth.value=this.metadataTarget.depthTexture}requestRender=()=>{!this.disposed&&!this.frameRequest&&document.visibilityState===`visible`&&(this.frameRequest=requestAnimationFrame(this.animate))};animate=(e=performance.now())=>{if(this.frameRequest=0,document.visibilityState!==`visible`)return;let t=(e-this.startedAt)/1e3,n=this.previousFrame?(e-this.previousFrame)/1e3:0;if(this.previousFrame=e,(this.playback?.update(n)??!1)&&this.playbackPanel.update(),this.idleObject.visible&&(this.idleObject.rotation.x=t*.08,this.idleObject.rotation.y=t*.14,this.idleObject.position.y=.1+Math.sin(t*.9)*.025),this.result&&this.modelBlend<1){this.modelBlend=Math.min(1,this.modelBlend+.025);let e=1-(1-this.modelBlend)**3;this.result.scale.setScalar(.82+e*.18)}let r=this.controls.update(),i=this.outline&&!!this.result&&!this.interacting;this.edgePass.enabled=i,i&&this.renderMetadata(),this.composer.render(),(this.idleObject.visible||this.modelBlend<1||this.controls.autoRotate||this.interacting||r||this.playback?.state().playing)&&this.requestRender()}},Df={model:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M11 21.725L4 17.7q-.475-.275-.737-.725t-.263-1v-7.95q0-.55.263-1T4 6.3l7-4.025Q11.475 2 12 2t1 .275L20 6.3q.475.275.738.725t.262 1v7.95q0 .55-.262 1T20 17.7l-7 4.025Q12.525 22 12 22t-1-.275m0-9.15v6.85L12 20l1-.575v-6.85L19 9.1V8.05l-1.075-.625L12 10.85L6.075 7.425L5 8.05V9.1z"/></svg>
`,toon:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M10.975 20.7q-.275-.275-.312-.662t.312-.738l8.325-8.325q.35-.35.738-.312t.662.312q.325.325.3.725t-.325.7l-8.3 8.3q-.3.3-.7.3t-.7-.3m7.225.3q-.35 0-.475-.3t.125-.55l2.3-2.3q.25-.25.55-.125t.3.475V20q0 .425-.287.713T20 21zm-14.925-.275q-.275-.275-.3-.675t.325-.75L19.325 3.275q.375-.375.775-.325t.675.325t.3.675t-.35.75L4.675 20.725q-.35.35-.737.313t-.663-.313m0-7.7q-.275-.275-.3-.675t.325-.75l8.3-8.3q.35-.35.738-.312T13 3.3t.313.663T13 4.7l-8.325 8.325q-.35.35-.737.312t-.663-.312M3 5.8V4q0-.425.288-.712T4 3h1.8q.35 0 .475.3t-.125.55l-2.3 2.3q-.25.25-.55.125T3 5.8"/></svg>
`,palette:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M12 22q-2.05 0-3.875-.788t-3.187-2.15t-2.15-3.187T2 12q0-2.075.813-3.9t2.2-3.175T8.25 2.788T12.2 2q2 0 3.775.688t3.113 1.9t2.125 2.875T22 11.05q0 2.875-1.75 4.413T16 17h-1.85q-.225 0-.312.125t-.088.275q0 .3.375.863t.375 1.287q0 1.25-.687 1.85T12 22m-4.425-9.425Q8 12.15 8 11.5t-.425-1.075T6.5 10t-1.075.425T5 11.5t.425 1.075T6.5 13t1.075-.425m3-4Q11 8.15 11 7.5t-.425-1.075T9.5 6t-1.075.425T8 7.5t.425 1.075T9.5 9t1.075-.425m5 0Q16 8.15 16 7.5t-.425-1.075T14.5 6t-1.075.425T13 7.5t.425 1.075T14.5 9t1.075-.425m3 4Q19 12.15 19 11.5t-.425-1.075T17.5 10t-1.075.425T16 11.5t.425 1.075T17.5 13t1.075-.425"/></svg>
`,outline:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M19.288 8.713Q19 8.425 19 8t.288-.712T20 7t.713.288T21 8t-.288.713T20 9t-.712-.288m0 4Q19 12.426 19 12t.288-.712T20 11t.713.288T21 12t-.288.713T20 13t-.712-.288m0 4Q19 16.426 19 16t.288-.712T20 15t.713.288T21 16t-.288.713T20 17t-.712-.288m-12 4Q7 20.426 7 20t.288-.712T8 19t.713.288T9 20t-.288.713T8 21t-.712-.288m4 0Q11 20.426 11 20t.288-.712T12 19t.713.288T13 20t-.288.713T12 21t-.712-.288m4 0Q15 20.426 15 20t.288-.712T16 19t.713.288T17 20t-.288.713T16 21t-.712-.288m4 0Q19 20.426 19 20t.288-.712T20 19t.713.288T21 20t-.288.713T20 21t-.712-.288M3 20V5q0-.825.588-1.412T5 3h15q.425 0 .713.288T21 4t-.288.713T20 5H5v15q0 .425-.288.713T4 21t-.712-.288T3 20"/></svg>
`,rotate:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M9.35 16.8q-3.2-.425-5.275-1.75T2 12q0-2.075 2.888-3.537T12 7t7.113 1.463T22 12q0 1.4-1.362 2.538t-3.613 1.787q-.4.125-.712-.112T16 15.574q0-.45.263-.8t.687-.5q1.5-.5 2.275-1.137T20 12q0-.8-2.138-1.9T12 9t-5.863 1.1T4 12q0 .6 1.275 1.438T8.9 14.7l-.6-.6q-.275-.275-.275-.7t.275-.7t.7-.275t.7.275l2.6 2.6q.3.3.3.7t-.3.7l-2.6 2.6q-.275.275-.687.288T8.3 19.3q-.275-.275-.288-.687t.263-.713z"/></svg>
`,grid:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21h2.675v-4.675H3V19q0 .825.588 1.413T5 21m4.675 0h4.65v-4.675h-4.65zm6.65 0H19q.825 0 1.413-.587T21 19v-2.675h-4.675zM3 14.325h4.675v-4.65H3zm6.675 0h4.65v-4.65h-4.65zm6.65 0H21v-4.65h-4.675zM3 7.675h4.675V3H5q-.825 0-1.412.588T3 5zm6.675 0h4.65V3h-4.65zm6.65 0H21V5q0-.825-.587-1.412T19 3h-2.675z"/></svg>
`,wire:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M11 19.475L6 16.6q-.475-.275-.737-.737T5 14.875v-5.75q0-.525.263-.987T6 7.4l5-2.875q.475-.275 1-.275t1 .275L18 7.4q.475.275.738.738t.262.987v5.75q0 .525-.262.988T18 16.6l-5 2.875q-.475.275-1 .275t-1-.275M3 8q-.425 0-.712-.288T2 7V4q0-.825.588-1.412T4 2h3q.425 0 .713.288T8 3t-.288.713T7 4H4v3q0 .425-.288.713T3 8m1 14q-.825 0-1.412-.587T2 20v-3q0-.425.288-.712T3 16t.713.288T4 17v3h3q.425 0 .713.288T8 21t-.288.713T7 22zm16 0h-3q-.425 0-.712-.288T16 21t.288-.712T17 20h3v-3q0-.425.288-.712T21 16t.713.288T22 17v3q0 .825-.587 1.413T20 22m0-15V4h-3q-.425 0-.712-.288T16 3t.288-.712T17 2h3q.825 0 1.413.588T22 4v3q0 .425-.288.713T21 8t-.712-.288T20 7M8.05 8.525l-1.05.6v1.125l4 2.325v4.6l1 .575l1-.575v-4.6l4-2.325V9.125l-1.05-.6L12 10.85z"/></svg>
`,fit:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M20 8V6h-2q-.425 0-.712-.288T17 5t.288-.712T18 4h2q.825 0 1.413.588T22 6v2q0 .425-.288.713T21 9t-.712-.288T20 8M2 8V6q0-.825.588-1.412T4 4h2q.425 0 .713.288T7 5t-.288.713T6 6H4v2q0 .425-.288.713T3 9t-.712-.288T2 8m18 12h-2q-.425 0-.712-.288T17 19t.288-.712T18 18h2v-2q0-.425.288-.712T21 15t.713.288T22 16v2q0 .825-.587 1.413T20 20M4 20q-.825 0-1.412-.587T2 18v-2q0-.425.288-.712T3 15t.713.288T4 16v2h2q.425 0 .713.288T7 19t-.288.713T6 20zm2-6v-4q0-.825.588-1.412T8 8h8q.825 0 1.413.588T18 10v4q0 .825-.587 1.413T16 16H8q-.825 0-1.412-.587T6 14"/></svg>
`};function Of(){return`<div class="viewer-toolbar" id="viewerToolbar">
    <span class="tool-segment" role="group">
      <button class="view-tool shading-tool" type="button" data-shading="original" data-i18n-title="originalMaterials">${Df.model}</button>
      <button class="view-tool shading-tool" type="button" data-shading="toon" data-i18n-title="toonOutline">${Df.toon}</button>
      <button class="view-tool shading-tool" type="button" data-shading="parts" data-i18n-title="partColors">${Df.palette}</button>
    </span>
    <span class="tool-divider"></span>
    <button class="view-tool active" id="outlineButton" type="button" data-i18n-title="toggleOutline">${Df.outline}</button>
    <button class="view-tool" id="rotateButton" type="button" data-i18n-title="toggleRotation">${Df.rotate}</button>
    <button class="view-tool" id="gridButton" type="button" data-i18n-title="toggleGrid">${Df.grid}</button>
    <button class="view-tool" id="wireButton" type="button" data-i18n-title="toggleWireframe">${Df.wire}</button>
    <button class="view-tool" id="fitButton" type="button" data-i18n-title="resetView">${Df.fit}</button>
  </div>`}var kf=new FontFace(`Google Sans Flex`,`url(${JSON.stringify(`/creation-model-viewer/GoogleSansFlex.woff`)}) format("woff")`,{style:`normal`,weight:`1 1000`,stretch:`25% 151%`});document.fonts.add(kf);var Af=kf.load(),jf=document.querySelector(`#viewerStage`);if(!jf)throw Error(`Missing viewer stage`);jf.innerHTML=`
  <canvas id="modelCanvas"></canvas>
  ${Of()}
  <div class="viewer-status" id="viewerStatus" role="status" aria-live="polite"></div>
`,document.documentElement.dataset.viewerVersion=`3`;function Mf(e){let t=jf?.querySelector(e);if(!t)throw Error(`Missing viewer node: ${e}`);return t}var Nf=Mf(`#modelCanvas`),Pf=Mf(`#viewerToolbar`),Ff=Mf(`#viewerStatus`),If=[...jf.querySelectorAll(`.shading-tool`)],Lf=Mf(`#outlineButton`),Rf=Mf(`#rotateButton`),zf=Mf(`#gridButton`),Bf=Mf(`#wireButton`),Vf=Mf(`#fitButton`),Hf=new Ef(Nf,jf),Uf={outline:!0,rotate:!1,grid:!1,wireframe:!1};function Wf(){If.forEach(e=>{let t=e.dataset.shading;e.classList.toggle(`active`,Hf.getShading()===t),e.disabled=t===`parts`&&!Hf.hasParts()}),Lf.classList.toggle(`active`,Uf.outline),Rf.classList.toggle(`active`,Uf.rotate),zf.classList.toggle(`active`,Uf.grid),Bf.classList.toggle(`active`,Uf.wireframe)}If.forEach(e=>e.addEventListener(`click`,()=>{Hf.setShading(e.dataset.shading),Wf()})),Lf.addEventListener(`click`,()=>{Uf.outline=!Uf.outline,Hf.setOutline(Uf.outline),Wf()}),Rf.addEventListener(`click`,()=>{Uf.rotate=!Uf.rotate,Hf.setAutoRotate(Uf.rotate),Wf()}),zf.addEventListener(`click`,()=>{Uf.grid=!Uf.grid,Hf.setGrid(Uf.grid),Wf()}),Bf.addEventListener(`click`,()=>{Uf.wireframe=!Uf.wireframe,Hf.setWireframe(Uf.wireframe),Wf()}),Vf.addEventListener(`click`,()=>Hf.fitView());var Gf=0,Kf=!1;async function qf(e){if(Kf||!e.modelUrl.startsWith(`${location.origin}/`))return;await Af.catch(()=>void 0);let t=++Gf;document.documentElement.dataset.theme=e.theme,Nf.setAttribute(`aria-label`,e.labels.preview),document.querySelectorAll(`[data-i18n-title]`).forEach(t=>{let n=t.dataset.i18nTitle,r=e.labels[n];r&&(t.title=r,t.setAttribute(`aria-label`,r))}),Hf.setTheme(e.theme),Hf.setPlaybackLabels(e.labels),Ff.hidden=!0,Pf.classList.remove(`visible`);try{if(!await Hf.setModel(e.modelUrl,e.segmented)||Kf||t!==Gf)return;Pf.classList.add(`visible`),Wf()}catch{if(Kf||t!==Gf)return;Ff.textContent=e.labels.previewUnavailable,Ff.hidden=!1}}function Jf(){Kf||(Kf=!0,++Gf,Hf.dispose())}Object.defineProperty(window,"sgtModelViewer",{configurable:!1,enumerable:!1,writable:!1,value:Object.freeze({start:qf,dispose:Jf,version:3})}),window.addEventListener(`pagehide`,Jf,{once:!0});