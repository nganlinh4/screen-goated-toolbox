...
void main() {
	...
	`}var Ts=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ta(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Hc(i,i.VERTEX_SHADER,y),S=Hc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Jc(i,x,`vertex`),n=Jc(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Fd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Id=new yo(-1,1,1,-1,0,1),Ld=new class extends Dr{constructor(){super(),this.setAttribute(`position`,new hr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new hr([0,2,0,0,2,0],2))}},Rd=class{constructor(e){this._mesh=new $r(Ld,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Id)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},zd=class extends Fd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof _a?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ma.clone(e.uniforms),this.material=new _a({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Rd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Bd=class extends Fd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Vd=class extends Fd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Hd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Jt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new zd(Pd),this.copyPass.material.blending=0,this.timer=new ko}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Bd!==void 0&&(r instanceof Bd?n=!0:r instanceof Vd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Ud={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Wd=class extends Fd{constructor(){super(),this.isOutputPass=!0,this.uniforms=ma.clone(Ud.uniforms),this.material=new va({name:Ud.name,uniforms:this.uniforms,vertexShader:Ud.vertexShader,fragmentShader:Ud.fragmentShader}),this._fsQuad=new Rd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Gd=class extends Fd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Kd=class{revision=0;activeAbort;settled=Promise.resolve();invalidate(){this.revision+=1,this.activeAbort?.abort()}async run(e,t){let n=++this.revision;this.activeAbort?.abort();let r=new AbortController;if(this.activeAbort=r,await this.settled,n!==this.revision||r.signal.aborted)return null;let i=e(r.signal);this.settled=i.then(()=>void 0,()=>void 0);try{let e=await i;return n!==this.revision||r.signal.aborted?(t(e),null):e}catch(e){if(n!==this.revision||r.signal.aborted)return null;throw e}finally{this.activeAbort===r&&(this.activeAbort=void 0)}}},qd=1024,Jd=5e5,Yd=15e5,Xd=class{parent;rank;constructor(e){this.parent=Int32Array.from({length:e},(e,t)=>t),this.rank=new Uint8Array(e)}find(e){let t=e;for(;this.parent[t]!==t;)t=this.parent[t];for(;this.parent[e]!==e;){let n=this.parent[e];this.parent[e]=t,e=n}return t}join(e,t){let n=this.find(e),r=this.find(t);n!==r&&(this.rank[n]<this.rank[r]&&([n,r]=[r,n]),this.parent[r]=n,this.rank[n]===this.rank[r]&&(this.rank[n]+=1))}};function Zd(e){let t=e.getAttribute(`position`),n=e.getIndex();if(!t||!n||t.count>Jd||n.count>Yd||n.count<6||n.count%3!=0||e.groups.length>1)return[];let r=new Xd(t.count);for(let e=0;e<n.count;e+=3){let i=n.getX(e),a=n.getX(e+1),o=n.getX(e+2);if(i>=t.count||a>=t.count||o>=t.count)return[];r.join(i,a),r.join(i,o)}let i=new Map;for(let e=0;e<n.count;e+=3){let t=n.getX(e),a=r.find(t),o=i.get(a)||[];if(o.push(t,n.getX(e+1),n.getX(e+2)),i.set(a,o),i.size>qd)return[]}return i.size>1?[...i.values()]:[]}function Qd(e,t){let n=new Dr;for(let t of Object.keys(e.attributes))n.setAttribute(t,e.getAttribute(t));let r=e.morphAttributes,i=n.morphAttributes;for(let[e,t]of Object.entries(r))i[e]=t;n.morphTargetsRelative=e.morphTargetsRelative;let a=t.reduce((e,t)=>Math.max(e,t),0)<=65535?new Uint16Array(t):new Uint32Array(t);return n.setIndex(new fr(a,1)),n}function $d(e,t){t.position.copy(e.position),t.quaternion.copy(e.quaternion),t.scale.copy(e.scale),t.matrix.copy(e.matrix),t.matrixAutoUpdate=e.matrixAutoUpdate,t.visible=e.visible,t.layers.mask=e.layers.mask,t.renderOrder=e.renderOrder,t.userData={...e.userData}}function ef(e,t){let n=e.parent;if(!n)return;let r=n.children.indexOf(e),i=new Tn;i.name=e.name,$d(e,i);for(let t of[...e.children])i.add(t);t.forEach((t,n)=>{let r=new $r(Qd(e.geometry,t),e.material);r.name=`part_${String(n+1).padStart(3,`0`)}`,r.castShadow=e.castShadow,r.receiveShadow=e.receiveShadow,r.frustumCulled=!1,r.userData={...e.userData},i.add(r)}),n.remove(e),n.add(i),n.children.splice(n.children.indexOf(i),1),n.children.splice(r,0,i),e.geometry.dispose()}function tf(e,t){let n=[];e.traverse(e=>{e instanceof $r&&!(e instanceof di)&&n.push(e)});let r=t&&n.length===1;for(let e of n){if(e.geometry.getAttribute(`normal`)||e.geometry.computeVertexNormals(),!r)continue;let t=Zd(e.geometry);t.length>1&&ef(e,t)}}var nf=`sgtQuadWireframe`;function rf(e){let t,n;return e.traverse(e=>{let r=e.userData;!r||r[nf]!==!0||(typeof r.polygonCount==`number`&&(t=r.polygonCount),typeof r.quadCount==`number`&&(n=r.quadCount))}),{polygons:t,quads:n}}function af(e){let t={vertices:0,faces:0},n=new WeakSet,r=new WeakSet,i=new WeakMap;e.traverse(e=>{if(!(e instanceof $r))return;let a=e.geometry.getAttribute(`position`);if(!a)return;n.has(a)||(n.add(a),t.vertices+=a.count);let o=e.geometry.getIndex();if(!o){r.has(a)||(r.add(a),t.faces+=Math.floor(a.count/3));return}let s=i.get(a);s||(s=new WeakSet,i.set(a,s)),s.has(o)||(s.add(o),t.faces+=Math.floor(o.count/3))});let{polygons:a,quads:o}=rf(e);return a!==void 0&&(t.polygons=a),o!==void 0&&(t.quads=o),t}var of={uniforms:{tDiffuse:{value:null},tMetadata:{value:null},tDepth:{value:null},uTexel:{value:new W(1,1)},uInk:{value:new Y(529682)},uStrength:{value:1}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function sf(e){return e.length===1?e[0]:e}function cf(e){return e.side=2,e.needsUpdate=!0,e}function lf(e,t){let n=e;return new xa({color:n.color?.clone()||new Y(16777215),map:n.map||null,normalMap:n.normalMap||null,alphaMap:n.alphaMap||null,aoMap:n.aoMap||null,emissive:n.emissive?.clone()||new Y(0),emissiveMap:n.emissiveMap||null,side:2,transparent:!0,opacity:0,vertexColors:n.vertexColors,gradientMap:t})}function uf(e,t,n){let r=e.map(cf),i=e.map(e=>lf(e,n)),a=e.map(()=>new xa({color:t,gradientMap:n,side:2,transparent:!0,opacity:0}));return{original:sf(r),toon:sf(i),parts:sf(a)}}var df=`sgtQuadWireframe`,ff=[2341279,15908181,6266856,15169880,10124244,6731896,13725086,5092040],pf=104857600,mf=class{canvas;container;renderer;scene=new Nn;camera=new mo(34,1,.01,100);controls;composer;edgePass;metadataTarget;metadataMaterial;metadataIds=new WeakMap;result=null;idleObject;grid=new Wo(4,20,2341279,4345935);startedAt=performance.now();modelBlend=0;hasSegmentedParts=!1;resizeObserver;shading=`toon`;outline=!0;wireframe=!1;quadEdges=[];contentRevision=0;modelLoads=new Kd;frameRequest=0;interacting=!1;interactionListener;theme=`dark`;disposed=!1;hemisphere=new to(15072245,1713444,2.15);key=new xo(16121849,3.2);rim=new xo(5556659,2);constructor(e,t){this.canvas=e,this.container=t,this.renderer=new lu({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`}),this.renderer.outputColorSpace=Be,this.renderer.setPixelRatio(this.pixelRatio()),this.camera.position.set(0,.1,3.4),this.controls=new yu(this.camera,this.canvas),this.controls.enableDamping=!1,this.controls.enablePan=!0,this.controls.minDistance=.7,this.controls.maxDistance=10,this.controls.autoRotateSpeed=1.15,this.controls.enabled=!1,this.controls.addEventListener(`start`,()=>{this.interacting=!0,this.interactionListener?.(!0),this.requestRender()}),this.controls.addEventListener(`change`,()=>this.requestRender()),this.controls.addEventListener(`end`,()=>{this.interacting=!1,this.interactionListener?.(!1),this.requestRender()}),this.key.position.set(3,4,5),this.rim.position.set(-4,1,-2),this.scene.add(this.hemisphere,this.key,this.rim),this.grid.position.y=-.82,this.grid.visible=!1,this.scene.add(this.grid);let n=new Jt(1,1,{depthBuffer:!0});n.samples=Math.min(2,this.renderer.capabilities.maxSamples),this.composer=new Hd(this.renderer,n),this.composer.addPass(new Gd(this.scene,this.camera)),this.edgePass=new zd(of),this.composer.addPass(this.edgePass),this.composer.addPass(new Wd),this.metadataTarget=new Jt(1,1,{depthBuffer:!0,depthTexture:new na(1,1,_),minFilter:o,magFilter:o}),this.metadataTarget.texture.colorSpace=``,this.metadataMaterial=new _a({uniforms:{uSurfaceId:{value:0}},vertexShader:`
      ...
      `,side:2,depthTest:!0,depthWrite:!0}),this.metadataMaterial.onBeforeRender=(e,t,n,r,i)=>{this.metadataMaterial.uniforms.uSurfaceId.value=this.metadataIds.get(i)||0},this.idleObject=this.createIdleObject(),this.scene.add(this.idleObject),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(t),this.setTheme(document.documentElement.dataset.theme===`light`?`light`:`dark`),this.resize(),this.requestRender()}onInteractionChange(e){this.interactionListener=e}dispose(){this.disposed||(this.disposed=!0,this.cancelPendingModelLoad(),this.frameRequest&&cancelAnimationFrame(this.frameRequest),this.frameRequest=0,this.resizeObserver.disconnect(),this.interactionListener=void 0,this.controls.dispose(),this.clearResult(),this.disposeGroup(this.idleObject),this.grid.geometry.dispose(),(Array.isArray(this.grid.material)?this.grid.material:[this.grid.material]).forEach(e=>e.dispose()),this.scene.userData.toonGradient?.dispose(),this.metadataMaterial.dispose(),this.metadataTarget.dispose(),this.composer.dispose(),this.renderer.dispose(),this.renderer.forceContextLoss())}pixelRatio(){return Math.min(1.5,Math.max(1,window.devicePixelRatio))}createIdleObject(){let e=new Tn,t=new sa(.68,3);return e.add(new $i(t,new Ji({color:2341279,size:.018,transparent:!0,opacity:.7})),new $r(t,new Vr({color:6717820,wireframe:!0,transparent:!0,opacity:.2}))),e.position.y=.12,e}setTheme(e){this.theme=e;let t=e===`light`?15988726:1317144;this.scene.background=new Y(t),this.renderer.setClearColor(t,1),this.edgePass.uniforms.uInk.value.set(e===`light`?2112310:463375),this.hemisphere.color.set(e===`light`?16777215:14679028),this.hemisphere.groundColor.set(e===`light`?10202282:1319199),this.key.color.set(e===`light`?16776693:15990777),this.rim.color.set(e===`light`?1481604:5556659),this.requestRender()}showIdle(){this.cancelPendingModelLoad(),this.clearResult(),this.idleObject.visible=!0,this.controls.enabled=!1,this.camera.position.set(0,.1,3.4),this.camera.lookAt(0,0,0),this.requestRender()}cancelPendingModelLoad(){++this.contentRevision,this.modelLoads.invalidate()}async setModel(e,t){let n=++this.contentRevision,r=await this.modelLoads.run(t=>this.loadModel(e,t),e=>this.disposeGroup(e));if(!r)return null;if(n!==this.contentRevision)return this.disposeGroup(r),null;try{this.idleObject.visible=!1,tf(r,t);let e=af(r),n=new Jn().setFromObject(r),i=n.getCenter(new G),a=n.getSize(new G);r.position.sub(i),r.scale.setScalar(1.55/Math.max(a.x,a.y,a.z,.001)),r.updateMatrixWorld(!0),this.adoptQuadEdges(r);let o=0;r.traverse(e=>{if(!(e instanceof $r))return;let t=uf(Array.isArray(e.material)?e.material:[e.material],ff[o%ff.length],this.toonGradient());e.userData.viewerMaterials=t,this.metadataIds.set(e,(o%254+1)/255),e.castShadow=!1,e.receiveShadow=!1,o+=1}),this.disposeGroup(this.result);let s=new Tn;return s.add(r),this.result=s,this.scene.add(s),this.hasSegmentedParts=t&&o>1,this.shading=this.hasSegmentedParts?`parts`:`toon`,this.applyMaterials(),this.modelBlend=0,this.controls.enabled=!0,this.resize(),this.fitView(),this.requestRender(),e}catch(e){throw this.disposeGroup(r),e}}async loadModel(e,t){let n=await fetch(e,{cache:`no-store`,signal:t});if(!n.ok)throw Error(`Model preview was unavailable`);let r=Number(n.headers.get(`content-length`)||0);if(r!==0&&(!Number.isSafeInteger(r)||r<20||r>pf))throw Error(`Model preview exceeded its size limit`);let i=await n.arrayBuffer();if(i.byteLength<20||i.byteLength>pf)throw Error(`Model preview exceeded its size limit`);if(t.aborted)throw Error(`Model preview was superseded`);return(await new Fu().parseAsync(i,``)).scene}toonGradient(){let e=this.scene.userData.toonGradient;if(e)return e;let t=new pi(new Uint8Array([72,132,194,255]),4,1,A);return t.minFilter=o,t.magFilter=o,t.colorSpace=``,t.needsUpdate=!0,this.scene.userData.toonGradient=t,t}setShading(e){e===`parts`&&!this.hasSegmentedParts||(this.shading=e,this.applyMaterials(),this.requestRender())}getShading(){return this.shading}hasParts(){return this.hasSegmentedParts}setOutline(e){this.outline=e,this.edgePass.uniforms.uStrength.value=e?.92:0,this.resize(),this.requestRender()}setAutoRotate(e){this.controls.autoRotate=e,this.requestRender()}setGrid(e){this.grid.visible=e&&!!this.result,this.requestRender()}setWireframe(e){this.wireframe=e,this.applyMaterials(),this.requestRender()}fitView(){if(!this.result)return;let e=new Jn().setFromObject(this.result),t=e.getSize(new G),n=e.getCenter(new G),r=Math.max(t.x,t.y,t.z)*.62,i=Math.max(1.7,r/Math.tan(Ot.degToRad(this.camera.fov*.5))*1.12);this.controls.target.copy(n),this.camera.position.set(n.x+i*.12,n.y+i*.04,n.z+i),this.camera.near=Math.max(.001,i/1e3),this.camera.far=i*50,this.camera.updateProjectionMatrix(),this.controls.update(),this.requestRender()}applyMaterials(){this.result?.traverse(e=>{if(!(e instanceof $r))return;let t=e.userData.viewerMaterials;t&&(e.material=t[this.shading],(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{`wireframe`in e&&(e.wireframe=this.wireframe&&!this.hasQuadEdges()),e.transparent=!0,e.opacity=this.modelBlend,e.needsUpdate=!0}))}),this.quadEdges.forEach(e=>{e.visible=this.wireframe;let t=e.material;t.opacity=this.modelBlend,t.needsUpdate=!0}),this.edgePass.uniforms.uStrength.value=this.outline?.92:0}hasQuadEdges(){return this.quadEdges.length>0}adoptQuadEdges(e){this.quadEdges=[],e.traverse(e=>{if(!(e instanceof Ki)||e.userData?.[df]!==!0)return;let t=new Pi({color:1185306,transparent:!0,opacity:0,depthTest:!0});(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()),e.material=t,e.renderOrder=2,e.visible=!1,this.quadEdges.push(e)})}clearResult(){this.disposeGroup(this.result),this.result=null,this.quadEdges=[],this.hasSegmentedParts=!1,this.grid.visible=!1,this.modelBlend=0,this.resize()}disposeGroup(e){if(!e)return;this.scene.remove(e);let t=new Set,n=new Set,r=this.scene.userData.toonGradient;e.traverse(e=>{if(!(e instanceof $r||e instanceof $i||e instanceof Ki))return;e.geometry?.dispose();let i=e.userData.viewerMaterials;(i?[i.original,i.toon,i.parts].flatMap(e=>Array.isArray(e)?e:[e]):Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{t.has(e)||(t.add(e),Object.values(e).forEach(e=>{e instanceof Gt&&e!==r&&!n.has(e)&&(n.add(e),e.dispose())}),e.dispose())})})}resize(){let e=Math.max(1,this.container.clientWidth),t=Math.max(1,this.container.clientHeight),n=this.pixelRatio();this.renderer.setPixelRatio(n),this.renderer.setSize(e,t,!1),this.composer.setPixelRatio(n),this.composer.setSize(e,t);let r=this.outline&&!!this.result;this.edgePass.enabled=r,this.metadataTarget.setSize(r?e*n:1,r?t*n:1),this.edgePass.uniforms.uTexel.value.set(.78/(e*n),.78/(t*n)),this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.requestRender()}renderMetadata(){let e=this.renderer.getRenderTarget(),t=this.scene.overrideMaterial,n=this.renderer.getClearColor(new Y),r=this.renderer.getClearAlpha();this.scene.overrideMaterial=this.metadataMaterial,this.renderer.setRenderTarget(this.metadataTarget),this.renderer.setClearColor(0,0),this.renderer.clear(!0,!0,!0),this.renderer.render(this.scene,this.camera),this.scene.overrideMaterial=t,this.renderer.setRenderTarget(e),this.renderer.setClearColor(n,r),this.edgePass.uniforms.tMetadata.value=this.metadataTarget.texture,this.edgePass.uniforms.tDepth.value=this.metadataTarget.depthTexture}requestRender=()=>{!this.disposed&&!this.frameRequest&&document.visibilityState===`visible`&&(this.frameRequest=requestAnimationFrame(this.animate))};animate=(e=performance.now())=>{if(this.frameRequest=0,document.visibilityState!==`visible`)return;let t=(e-this.startedAt)/1e3;if(this.idleObject.visible&&(this.idleObject.rotation.x=t*.08,this.idleObject.rotation.y=t*.14,this.idleObject.position.y=.1+Math.sin(t*.9)*.025),this.result&&this.modelBlend<1){this.modelBlend=Math.min(1,this.modelBlend+.025);let e=1-(1-this.modelBlend)**3;this.result.scale.setScalar(.82+e*.18),this.result.traverse(t=>{t instanceof $r&&(Array.isArray(t.material)?t.material:[t.material]).forEach(t=>{t.opacity=e})})}let n=this.controls.update(),r=this.outline&&!!this.result&&!this.interacting;this.edgePass.enabled=r,r&&this.renderMetadata(),this.composer.render(),(this.idleObject.visible||this.modelBlend<1||this.controls.autoRotate||this.interacting||n)&&this.requestRender()}},hf={model:`<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M11 21.725L4 17.7q-.475-.275-.737-.725t-.263-1v-7.95q0-.55.263-1T4 6.3l7-4.025Q11.475 2 12 2t1 .275L20 6.3q.475.275.738.725t.262 1v7.95q0 .55-.262 1T20 17.7l-7 4.025Q12.525 22 12 22t-1-.275m0-9.15v6.85L12 20l1-.575v-6.85L19 9.1V8.05l-1.075-.625L12 10.85L6.075 7.425L5 8.05V9.1z"/></svg>
...
`};function gf(){return`<div class="viewer-toolbar" id="viewerToolbar">
    <span class="tool-segment" role="group">
      <button class="view-tool shading-tool" type="button" data-shading="original" data-i18n-title="originalMaterials">${hf.model}</button>
      <button class="view-tool shading-tool" type="button" data-shading="toon" data-i18n-title="toonOutline">${hf.toon}</button>
      <button class="view-tool shading-tool" type="button" data-shading="parts" data-i18n-title="partColors">${hf.palette}</button>
    </span>
    <span class="tool-divider"></span>
    <button class="view-tool active" id="outlineButton" type="button" data-i18n-title="toggleOutline">${hf.outline}</button>
    <button class="view-tool" id="rotateButton" type="button" data-i18n-title="toggleRotation">${hf.rotate}</button>
    <button class="view-tool" id="gridButton" type="button" data-i18n-title="toggleGrid">${hf.grid}</button>
    <button class="view-tool" id="wireButton" type="button" data-i18n-title="toggleWireframe">${hf.wire}</button>
    <button class="view-tool" id="fitButton" type="button" data-i18n-title="resetView">${hf.fit}</button>
  </div>`}var _f=new FontFace(`Google Sans Flex`,`url(${JSON.stringify(`/creation-model-viewer/GoogleSansFlex.woff`)}) format("woff")`,{style:`normal`,weight:`1 1000`,stretch:`25% 151%`});document.fonts.add(_f);var vf=_f.load(),yf=document.querySelector(`#viewerStage`);if(!yf)throw Error(`Missing viewer stage`);yf.innerHTML=`
  <canvas id="modelCanvas"></canvas>
  ${gf()}
  <div class="viewer-status" id="viewerStatus" role="status" aria-live="polite"></div>
`,document.documentElement.dataset.viewerVersion=`2`;function bf(e){let t=yf?.querySelector(e);if(!t)throw Error(`Missing viewer node: ${e}`);return t}var xf=bf(`#modelCanvas`),Sf=bf(`#viewerToolbar`),Cf=bf(`#viewerStatus`),wf=[...yf.querySelectorAll(`.shading-tool`)],Tf=bf(`#outlineButton`),Ef=bf(`#rotateButton`),Df=bf(`#gridButton`),Of=bf(`#wireButton`),kf=bf(`#fitButton`),Af=new mf(xf,yf),jf={outline:!0,rotate:!1,grid:!1,wireframe:!1};function Mf(){wf.forEach(e=>{let t=e.dataset.shading;e.classList.toggle(`active`,Af.getShading()===t),e.disabled=t===`parts`&&!Af.hasParts()}),Tf.classList.toggle(`active`,jf.outline),Ef.classList.toggle(`active`,jf.rotate),Df.classList.toggle(`active`,jf.grid),Of.classList.toggle(`active`,jf.wireframe)}wf.forEach(e=>e.addEventListener(`click`,()=>{Af.setShading(e.dataset.shading),Mf()})),Tf.addEventListener(`click`,()=>{jf.outline=!jf.outline,Af.setOutline(jf.outline),Mf()}),Ef.addEventListener(`click`,()=>{jf.rotate=!jf.rotate,Af.setAutoRotate(jf.rotate),Mf()}),Df.addEventListener(`click`,()=>{jf.grid=!jf.grid,Af.setGrid(jf.grid),Mf()}),Of.addEventListener(`click`,()=>{jf.wireframe=!jf.wireframe,Af.setWireframe(jf.wireframe),Mf()}),kf.addEventListener(`click`,()=>Af.fitView());var Nf=0,Pf=!1;async function Ff(e){if(Pf||!e.modelUrl.startsWith(`${location.origin}/`))return;await vf.catch(()=>void 0);let t=++Nf;document.documentElement.dataset.theme=e.theme,xf.setAttribute(`aria-label`,e.labels.preview),document.querySelectorAll(`[data-i18n-title]`).forEach(t=>{let n=t.dataset.i18nTitle,r=e.labels[n];r&&(t.title=r,t.setAttribute(`aria-label`,r))}),Af.setTheme(e.theme),Cf.hidden=!0,Sf.classList.remove(`visible`);try{if(!await Af.setModel(e.modelUrl,e.segmented)||Pf||t!==Nf)return;Sf.classList.add(`visible`),Mf()}catch{if(Pf||t!==Nf)return;Cf.textContent=e.labels.previewUnavailable,Cf.hidden=!1}}function If(){Pf||(Pf=!0,++Nf,Af.dispose())}Object.defineProperty(window,"sgtModelViewer",{configurable:!1,enumerable:!1,writable:!1,value:Object.freeze({start:Ff,dispose:If,version:2})}),window.addEventListener(`pagehide`,If,{once:!0});