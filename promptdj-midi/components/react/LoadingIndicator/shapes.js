// Shape factory functions for the Material 3 Expressive loading indicator.
// Pure builders extracted from LoadingIndicator.jsx — each takes a RoundedPolygon
// constructor (and size/radius) and returns a shape, with no React/component state.
