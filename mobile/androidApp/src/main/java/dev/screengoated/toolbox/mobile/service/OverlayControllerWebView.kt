...
private fun overlayLocaleJson(uiLanguage: String): String {
    ...
    return JSONObject().apply {
        ...
        put("s2sTranslationModelTitle", overlay.s2sTranslationModelTitle)
        put("s2sTargetLanguageTitle", overlay.s2sTargetLanguageTitle)
        put("directSpeechTitle", overlay.directSpeechTitle)
        put("ttsS2sLockedTitle", overlay.ttsS2sLockedTitle)
        put("ttsEnableTitle", overlay.ttsEnableTitle)
