...
internal data class CreationJobStatus(
    ...
    val segmentationLevel: String? = null,
    val projectId: String? = null,
    val parentRevisionId: String? = null,
    val revisionKind: String? = null,
    val supportedActions: List<String>? = null,
    val availableActions: List<String> = emptyList(),
    val isTextured: Boolean = false,
    val isPbr: Boolean = false,
...
internal data class CreationWorkerRequest(
    ...
    val parentRevisionId: String? = null,
    val revisionKind: String? = null,
    val refinementKind: String? = null,
    val targetFaces: Int? = null,
...
internal data class CreationWorkerEvent(
    ...
    val isTextured: Boolean? = null,
    val isPbr: Boolean? = null,
    val isRigged: Boolean? = null,
    val rigType: String? = null,
    val canRefine: Boolean? = null,
    val faces: Long? = null,
    val vertices: Long? = null,
    val polygons: Long? = null,
    val quads: Long? = null,
