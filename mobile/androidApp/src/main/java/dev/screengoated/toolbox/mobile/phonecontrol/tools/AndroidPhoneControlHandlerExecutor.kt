...
internal class AndroidPhoneControlHandlerExecutor(
    ...
    private val grounding = VisualGroundingToolHandlers(context)
    ...
    override suspend fun execute(
        ...
        PhoneControlHandler.CLICK_TARGET -> grounding.clickTarget(job, arguments)
        PhoneControlHandler.MAP_TARGETS -> grounding.mapTargets(job, arguments)
        PhoneControlHandler.CLICK_MARK -> grounding.clickMark(job, arguments)
        ...
        PhoneControlHandler.DRAG_TARGET -> grounding.dragTarget(job, arguments)
