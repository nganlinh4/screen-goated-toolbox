...
internal fun DownloadedToolsDialog(
    ...
    // Parakeet
    val parakeetManager = remember { app.appContainer.parakeetModelManager }
    val parakeetState by parakeetManager.state.collectAsState()
            ...
            ExpressiveDialogSectionCard(accent = MaterialTheme.colorScheme.secondary) {
                ...
                DownloadedToolRow(
                    ...
                    progressFraction = if (parakeetState is ParakeetModelState.Downloading) {
                        (parakeetState as ParakeetModelState.Downloading).progress / 100f
                    } else {
                        null
                    },
