...
internal class CreationFileStore(internal val context: Context) {
    ...
    fun importImages(
        ...
        ensureCreationStorageAvailable(
            ...
            outputDestinationSnapshot(tool),
        )
    ...
    fun defaultOutputDirectoryLabel(tool: CreationTool): String =
        outputs.defaultDirectoryLabel(tool)
    ...
    fun outputDestinationSnapshot(tool: CreationTool): String? = outputs.destinationSnapshot(tool)
    ...
    private fun ensureCreationStorageAvailable(
        ...
        val requirements = creationStorageRequirements(
            sourceSnapshotBytes,
            resultBytes,
            managedDestination = destination == null && tool == CreationTool.IMAGE_CREATOR,
