...
def generate_live_kotlin(manifest: dict, output_path: Path) -> None:
    ...
    lines: list[str] = [
        ...
        f"    const val TRANSLATION_PROVIDER_TAALAS = {kotlin_string(constants['realtime_translation_model_taalas'])}",
        ...
        f"    const val TAALAS_API_MODEL = {kotlin_string(provider_api_by_id[constants['realtime_translation_model_taalas']])}",
    ...
    lines.extend(
        [
            ...
            "        return when (id) {",
            "            TRANSLATION_PROVIDER_TAALAS -> ProviderDescriptor(",
            "                id = TRANSLATION_PROVIDER_TAALAS,",
