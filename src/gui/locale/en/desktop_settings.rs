...
pub(super) fn get() -> DesktopSettingsLocaleText {
    DesktopSettingsLocaleText {
        ...
        preset_model_update_title: "Apply new preset model settings?",
        preset_model_update_body: "This update includes newer recommended models for some presets. Applying it changes only those presets' model fields; prompts, graphs, modes, favorites, hotkeys, and every other setting stay unchanged. The model priority lists are also updated to the new defaults. If you skip, you can still get the new defaults later by restoring all presets or an individual preset.",
