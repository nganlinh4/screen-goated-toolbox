...
pub(super) fn get() -> ModelCatalogLocaleText {
    ModelCatalogLocaleText {
        models_hub_button: "Models",
        models_hub_tab_priority: "Priority",
        models_hub_tab_usage: "Usage",
        models_hub_tab_custom: "Custom",
        model_priority_image_chain_title: "Image → Text",
        model_priority_text_chain_title: "Text → Text",
        model_priority_live_toggle: "Live",
        model_priority_live_toggle_hint: "Include healthy live models in this priority chain",
