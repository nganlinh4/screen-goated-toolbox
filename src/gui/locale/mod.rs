...
pub struct LocaleText {
    ...
    pub bilingual_relay_btn: &'static str,
    pub bilingual_relay_title: &'static str,
    pub bilingual_relay_first_profile: &'static str,
    pub bilingual_relay_second_profile: &'static str,
    pub bilingual_relay_language_label: &'static str,
    pub bilingual_relay_accent_label: &'static str,
    pub bilingual_relay_tone_label: &'static str,
    pub bilingual_relay_hotkey_label: &'static str,
    pub bilingual_relay_hotkey_set: &'static str,
    pub bilingual_relay_hotkey_clear: &'static str,
    pub bilingual_relay_hotkey_conflict: &'static str,
    pub bilingual_relay_apply: &'static str,
    pub bilingual_relay_start: &'static str,
    pub bilingual_relay_stop: &'static str,
    pub bilingual_relay_transcript_title: &'static str,
    pub bilingual_relay_input_chip: &'static str,
    pub bilingual_relay_output_chip: &'static str,
    pub bilingual_relay_no_transcript_yet: &'static str,
    pub bilingual_relay_status_not_configured: &'static str,
    pub bilingual_relay_status_connecting: &'static str,
    pub bilingual_relay_status_ready: &'static str,
    pub bilingual_relay_status_reconnecting: &'static str,
    pub bilingual_relay_status_error: &'static str,
    pub bilingual_relay_status_stopped: &'static str,
    pub bilingual_relay_api_key_required: &'static str,
