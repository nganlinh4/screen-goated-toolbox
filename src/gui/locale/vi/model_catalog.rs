...
pub(super) fn get() -> ModelCatalogLocaleText {
    ModelCatalogLocaleText {
        models_hub_button: "Mô hình",
        models_hub_tab_priority: "Ưu tiên",
        models_hub_tab_usage: "Thống kê",
        models_hub_tab_custom: "Tuỳ chỉnh",
        model_priority_image_chain_title: "Ảnh → Text",
        model_priority_text_chain_title: "Text → Text",
        model_priority_live_toggle: "Live",
        model_priority_live_toggle_hint: "Thêm các mô hình live đang hoạt động tốt vào chuỗi ưu tiên này",
