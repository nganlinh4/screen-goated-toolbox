...
pub fn get() -> LocaleText {
    LocaleText {
        ...
        bilingual_relay_btn: "Bánh mỳ chuyển ngữ",
        bilingual_relay_title: "Bánh mỳ chuyển ngữ",
        bilingual_relay_first_profile: "Ngôn ngữ 1",
        bilingual_relay_second_profile: "Ngôn ngữ 2",
        bilingual_relay_language_label: "Ngôn ngữ",
        bilingual_relay_accent_label: "Giọng vùng",
        bilingual_relay_tone_label: "Tông giọng",
        bilingual_relay_hotkey_label: "Phím tắt",
        bilingual_relay_hotkey_set: "Thêm phím tắt",
        bilingual_relay_hotkey_clear: "Xóa phím tắt",
        bilingual_relay_hotkey_conflict: "Phím tắt đã bị dùng",
        bilingual_relay_apply: "Áp dụng",
        bilingual_relay_start: "Bắt đầu",
        bilingual_relay_stop: "Dừng",
        bilingual_relay_transcript_title: "Bản chép",
        bilingual_relay_input_chip: "Đầu vào",
        bilingual_relay_output_chip: "Đầu ra",
        bilingual_relay_no_transcript_yet: "Chưa có bản chép nào.",
        bilingual_relay_status_not_configured: "Chưa cấu hình",
        bilingual_relay_status_connecting: "Đang kết nối",
        bilingual_relay_status_ready: "Sẵn sàng",
        bilingual_relay_status_reconnecting: "Đang nối lại",
        ...
        bilingual_relay_current_model: "Model hiện tại",
        bilingual_relay_current_voice: "Giọng hiện tại",
        ...
        qwen3_server_downloading_message: "Vui lòng đợi... đang lấy server tham chiếu cục bộ.",
        ...
        tool_desc_ai_runtime: "Runtime cần thiết cho Parakeet ASR cục bộ",
        ...
        tool_desc_qwen3_server: "Gói sidecar tham chiếu Windows do SGT sở hữu dùng cho baseline realtime Qwen hiện tại",
