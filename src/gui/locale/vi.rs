...
pub fn get() -> LocaleText {
    LocaleText {
        ...
        tool_ai_runtime: "Runtime AI cục bộ",
        ...
        tool_desc_qwen3: "Dùng trong Dịch cabin làm mô hình giọng nói offline \"Qwen3-ASR\"",
        tool_qwen3_runtime: "Runtime CUDA Qwen3-ASR",
        tool_desc_qwen3_runtime: "Engine suy luận gốc cho Qwen3-ASR (cần GPU NVIDIA)",
