...
pub fn get() -> LocaleText {
    LocaleText {
        ...
        tool_ai_runtime: "Local AI Runtime",
        ...
        tool_desc_qwen3: "Used in Cabin Translation as the \"Qwen3-ASR\" offline speech model",
        tool_qwen3_runtime: "Qwen3-ASR CUDA Runtime",
        tool_desc_qwen3_runtime: "Native inference engine for Qwen3-ASR (requires NVIDIA GPU)",
