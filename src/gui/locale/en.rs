...
pub fn get() -> LocaleText {
    LocaleText {
        ...
        bilingual_relay_btn: "Bilingual Relay",
        bilingual_relay_title: "Translation Gummy",
        bilingual_relay_first_profile: "Language 1",
        bilingual_relay_second_profile: "Language 2",
        bilingual_relay_language_label: "Language",
        bilingual_relay_accent_label: "Accent",
        bilingual_relay_tone_label: "Tone",
        bilingual_relay_hotkey_label: "Hotkey",
        bilingual_relay_hotkey_set: "Add hotkey",
        bilingual_relay_hotkey_clear: "Clear hotkey",
        bilingual_relay_hotkey_conflict: "Hotkey already used",
        bilingual_relay_apply: "Apply",
        bilingual_relay_start: "Start",
        bilingual_relay_stop: "Stop",
        bilingual_relay_transcript_title: "Transcript",
        bilingual_relay_input_chip: "Input",
        bilingual_relay_output_chip: "Output",
        bilingual_relay_no_transcript_yet: "No transcript yet.",
        bilingual_relay_status_not_configured: "Not configured",
        bilingual_relay_status_connecting: "Connecting",
        bilingual_relay_status_ready: "Ready",
        bilingual_relay_status_reconnecting: "Reconnecting",
        ...
        bilingual_relay_current_model: "Current model",
        bilingual_relay_current_voice: "Current voice",
        ...
        qwen3_server_downloading_message: "Please wait... fetching the local reference server.",
        ...
        tool_desc_ai_runtime: "Required for local Parakeet ASR",
        ...
        tool_desc_qwen3_server: "SGT-owned Windows reference sidecar bundle used by the current Qwen realtime baseline",
