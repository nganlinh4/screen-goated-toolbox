...
pub fn get() -> LocaleText {
    LocaleText {
        ...
        tool_desc_ai_runtime: "로컬 Parakeet ASR 필수 런타임",
        ...
        tool_desc_qwen3_server: "현재 Qwen 실시간 베이스라인이 사용하는 SGT 소유 Windows 레퍼런스 사이드카 번들",
        ...
        bilingual_relay_btn: "통역 곤약",
        bilingual_relay_title: "통역 곤약",
        bilingual_relay_first_profile: "언어 1",
        bilingual_relay_second_profile: "언어 2",
        bilingual_relay_language_label: "언어",
        bilingual_relay_accent_label: "억양",
        bilingual_relay_tone_label: "말투",
        bilingual_relay_hotkey_label: "단축키",
        bilingual_relay_hotkey_set: "단축키 추가",
        bilingual_relay_hotkey_clear: "단축키 지우기",
        bilingual_relay_hotkey_conflict: "이미 사용 중인 단축키",
        bilingual_relay_apply: "적용",
        bilingual_relay_start: "시작",
        bilingual_relay_stop: "중지",
        bilingual_relay_transcript_title: "전사",
        bilingual_relay_input_chip: "입력",
        bilingual_relay_output_chip: "출력",
        bilingual_relay_no_transcript_yet: "아직 전사가 없습니다.",
        bilingual_relay_status_not_configured: "설정 안 됨",
        bilingual_relay_status_connecting: "연결 중",
        bilingual_relay_status_ready: "준비됨",
        bilingual_relay_status_reconnecting: "다시 연결 중",
        bilingual_relay_status_error: "오류",
        bilingual_relay_status_stopped: "중지됨",
        bilingual_relay_api_key_required: "통역 곤약을 시작하기 전에 Gemini API 키를 추가하세요.",
        bilingual_relay_chat_history: "대화 기록",
        bilingual_relay_tts_settings_hint: "Gemini Live 모델과 음성을 원하는 대로 변경하세요!",
        bilingual_relay_guide: "사용법: 설정된 두 언어 중 하나로 문장을 말하면, 다른 언어로 번역되어 읽어줍니다.",
        bilingual_relay_guide_ok: "알겠습니다!",
        bilingual_relay_current_model: "현재 모델",
        bilingual_relay_current_voice: "현재 음성",
        ...
        qwen3_server_downloading_message: "잠시만 기다려주세요... 로컬 레퍼런스 서버를 가져오는 중입니다.",
