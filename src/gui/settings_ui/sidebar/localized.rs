...
pub fn get_localized_preset_name(preset_id: &str, lang_code: &str) -> String {
    ...
    match (preset_id, lang_code) {
        ...
        ("preset_transcribe_english_offline", "vi") => "Chép liên tục".to_string(),
        ...
        ("preset_transcribe_english_offline", "ko") => "연속 받아쓰기".to_string(),
        ...
        ("preset_transcribe_english_offline", _) => "Continuous transcription".to_string(),
