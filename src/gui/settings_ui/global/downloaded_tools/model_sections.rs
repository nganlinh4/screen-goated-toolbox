...
pub(super) fn render_parakeet_section(ui: &mut egui::Ui, text: &LocaleText) {
    ui.group(|ui| {
...
pub(super) fn render_qwen3_section(ui: &mut egui::Ui, text: &LocaleText) {
    ui.group(|ui| {
...
pub(super) fn render_qwen3_1_7b_section(ui: &mut egui::Ui, text: &LocaleText) {
    ui.group(|ui| {
        ui.horizontal(|ui| {
...
pub(super) fn render_qwen3_runtime_section(ui: &mut egui::Ui, text: &LocaleText) {
    ui.group(|ui| {
