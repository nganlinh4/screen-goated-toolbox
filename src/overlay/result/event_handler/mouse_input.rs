...
use crate::overlay::result::state::{WINDOW_STATES, InteractionMode, ResizeEdge};
use crate::overlay::result::layout::{
    get_copy_btn_rect, get_edit_btn_rect, get_undo_btn_rect, get_redo_btn_rect, 
    get_markdown_btn_rect, get_download_btn_rect, get_speaker_btn_rect, 
    get_resize_edge, should_show_buttons
};
