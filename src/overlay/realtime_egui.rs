...
fn render_main_ui(ui: &mut egui::Ui, state: &mut RealtimeUiState) {
    ...
    ui.horizontal(|ui| {
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            // Visibility toggles
            if ui
                .selectable_label(state.show_translation, "🌐")
            ...
            if ui
                .selectable_label(state.show_transcription, "📝")
                ...
                ui.menu_button(model_label, |ui| {
                    ...
                    if ui
                        .selectable_label(
                            ...
                            format!("🌍 {}", locale.google_gtx_label),
                        )
                        .clicked()
                    {
                        if let Ok(mut m) = NEW_TRANSLATION_MODEL.lock() {
            ...
            // Audio source toggle
            if ui
                .selectable_label(!is_device_mode, "🎤")
    ...
    if state.show_app_picker {
        ui.horizontal(|ui| {
            ...
            if !selected_name.is_empty() {
                ui.label(
                    egui::RichText::new(format!("✓ {}", selected_name))
