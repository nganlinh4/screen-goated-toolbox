...
impl Grid {
    ...
    pub fn cell_at(&self, mx: f64, my: f64) -> u32 {
        let c = ((mx / 1000.0 * self.cols as f64).floor() as i64).clamp(0, self.cols as i64 - 1) as u32;
        let r = ((my / 1000.0 * self.rows as f64).floor() as i64).clamp(0, self.rows as i64 - 1) as u32;
        r * self.cols + c + 1
    }
