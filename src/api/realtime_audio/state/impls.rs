use super::{
    AI_SILENCE_TIMEOUT_MS, MIN_FORCE_COMMIT_CHARS, PARAKEET_BASE_TIMEOUT_MS,
    PARAKEET_MIN_TIMEOUT_MS, PARAKEET_MIN_WORDS, PARAKEET_SHORT_TIMEOUT_MS,
    PARAKEET_TIMEOUT_DECAY_RATE, RealtimeState, TranscriptionMethod, TranslationRequest,
...
impl RealtimeState {
    ...
    fn calculate_parakeet_timeout_ms(&self) -> u64 {
        ...
        // Wait longer for short phrases to prevent cutting off sentences mid-thought.
        if word_count < 5 {
