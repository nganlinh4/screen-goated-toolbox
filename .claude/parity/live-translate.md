...
- Ordinary continuous-audio presets that select the same endpoint reuse its
  ...
  visible progress; history and continuous auto-paste consume authoritative finals
  only. Presets reuse the shared hybrid speech-end reducer, finalizing successive
