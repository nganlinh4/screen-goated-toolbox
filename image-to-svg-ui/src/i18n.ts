...
const messages = {
  en: {
    ...
    selectJob: "Select a result to inspect it", selected: "selected", newBatch: "Add another batch",
  },
  ko: {
    ...
    selectJob: "결과를 선택해 확인하세요", selected: "개 선택됨", newBatch: "새 작업 추가",
  },
  vi: {
    ...
    selectJob: "Chọn một kết quả để xem", selected: "đã chọn", newBatch: "Thêm lượt mới",
  },
} as const;
