...
const MANIFEST_ENV: &str = "SGT_QWEN3_RUNTIME_DELIVERY_MANIFEST";
const DEFAULT_MANIFEST: &str =
    "local-runtime-bundles/sgt_qwen3_runtime/sgt_qwen3_runtime.delivery.json";
...
pub(crate) fn generate(manifest_dir: &Path, out_dir: &Path) {
    ...
    let generated = if configured.is_file() {
        ...
        "const QWEN_RUNTIME_DELIVERY: Option<QwenRuntimeDelivery> = None;\n".to_string()
    };
