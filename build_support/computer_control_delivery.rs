...
const MANIFEST_ENV: &str = "SGT_COMPUTER_CONTROL_DELIVERY_MANIFEST";
const DEFAULT_MANIFEST: &str =
    "local-runtime-bundles/sgt_computer_control/sgt_computer_control.delivery.json";
...
pub(crate) fn generate(manifest_dir: &Path, out_dir: &Path) {
    ...
    let generated = if configured.is_file() {
        ...
        "const ENGINE_DELIVERY: Option<EngineDelivery> = None;\n".to_string()
    };
